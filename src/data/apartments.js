...
export const APARTMENTS = [
  ...
  // ────── D · 80 m² · 3 rooms (tower only) ──────
  {
    code: 'D',
    title: 'טיפוס D · 80 מ״ר',
    categoryLabel: '3 חדרים',
    category: 'apartment',
    rooms: 3,
    builtSqm: 80,
  ...
  // ────── H · 80 m² · 3 rooms (west boutique) ──────
  {
    code: 'H',
    title: 'טיפוס H · 80 מ״ר',
    categoryLabel: '3 חדרים',
    category: 'apartment',
    rooms: 3,
    builtSqm: 80,
  ...
  // ────── F · 110 m² · 4 rooms (tower only) ──────
  {
    code: 'F',
    title: 'טיפוס F · 110 מ״ר',
  ...
  // ────── G · 119–123 m² · 5 rooms (west boutique) ──────
  {
    code: 'G',
    title: 'טיפוס G · 119 מ״ר',
  ...
  // ────── B-123 · 119 m² · 5 rooms (north boutique, west corner) ──────
  {
    code: 'B-123',
    title: 'טיפוס B · 119 מ״ר',
  ...
  // ────── B-134 · 130 m² · 5 rooms (north boutique, east corner) ──────
  {
    code: 'B-134',
    title: 'טיפוס B · 130 מ״ר',
  ...
  // ────── C · 130 m² · 5 rooms (tower only) ──────
  {
    code: 'C',
    title: 'טיפוס C · 130 מ״ר',
...
export const BUILDINGS = {
  tower: {
    ...
    mix: [
      ...
      'קומות 2–7: 7 דירות בקומה (2× F-110, 3× E-67, 1× D-80, 1× C-130)',
  ...
  'boutique-w': {
    ...
    mix: [
      ...
      'קומות 2–6: 4 דירות בקומה — G-119 בפינות (5 חד׳), H-80 באמצע (3 חד׳)',
  ...
  'boutique-n': {
    ...
    mix: [
      ...
      'קומות 2–6: 6 דירות בקומה — B-119 בקצה מערבי (5 חד׳), 4× A-80 באמצע (3 חד׳), B-130 בקצה מזרחי (5 חד׳)',
