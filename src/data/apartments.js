...
export const APARTMENTS = [
  ...
  // ────── Boutique penthouses ──────
  {
    ...
    buildings: ['boutique-w'],
    description:
      'פנטהאוז בקומה 7 של מרקמי מערבי — 2 פנטהאוזים, אחד בכל בניין. 150 מ״ר בנוי + 66 מ״ר מרפסת גג. הצפוני: חזיתות מערב·צפון·מזרח. הדרומי: מערב·דרום·מזרח. התוכנית המפורטת תפורסם בקרוב.',
  ...
  },
  {
    ...
    buildings: ['boutique-n'],
    description:
      'פנטהאוז בקומה 7 של מרקמי צפוני — 3 פנטהאוזים, אחד בכל בניין. 150 מ״ר בנוי + מרפסת גג גדולה (68, 37 ו־80 מ״ר). הבניין המערבי: חזיתות צפון·מערב·דרום. האמצעי: צפון·דרום. המזרחי: צפון·מזרח·דרום. התוכנית המפורטת תפורסם בקרוב.',
  ...
  {
    code: 'G-128',
    title: 'דירת גן · 113 מ״ר + 128 גינה',
...
export const BUILDINGS = {
  ...
  'boutique-n': {
    ...
    mix: [
      'קרקע: לובי + 3 חנויות (155, 83, 122 מ״ר) — חזית מסחרית לכיוון צפון',
      'קומות 2–6: 6 דירות בקומה — B-123 בקצה מערבי (5 חד׳), 4× A-82 באמצע (3 חד׳), B-134 בקצה מזרחי (5 חד׳)',
      'קומה 7: 3 פנטהאוזים — 150 מ״ר + מרפסות גג של 68, 37 ו־80 מ״ר',
    ],
  },
}
